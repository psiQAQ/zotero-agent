...
2. Register an application in the Portal, select `Public: Native/Mobile Application` as its Client Type, and describe its purpose. Register a distinct application for your Zotero integration; do not use another person's or a publicly shared Key.
