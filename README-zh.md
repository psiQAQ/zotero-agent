...
它提供 **46 个工具**，覆盖文献检索、元数据补全、按标识符导入（DOI / arXiv / ISBN / PMID）、批量文献导入（BibTeX / RIS / CSL-JSON）、预印本升级正式版、DOI 修复、灰色源 PDF 下载（Sci-Hub / Anna's Archive）、查重与合并、批量打标签、引文图扩展、注释综述、伴生插件桥接（茉莉花、Linter）——外加一个兜底的 `run_javascript`，可在 Zotero 进程内执行内置工具之外的任意自动化。
...
| 工具 | 27 | **46** —— 新增 19 个（标识符与批量文献导入、缺 PDF 审计、引文图、查重、批量标签、元数据补全、DOI 反查与修复、预印本升级、灰色源下载、伴生插件桥接 等） |
